...
@{
  ...
  cp='Alton''s older housing stock can add existing-condition questions to a remodeling plan, including structure, utilities, access, and finish transitions. All-Pro reviews remodeling requests in Alton and Madison County and prepares the scope around the actual property, requested work, trade responsibilities, selections, allowances, and documented changes.'
  sl=$SL_REMODEL
