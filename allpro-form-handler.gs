...
function normalizedLead(data) {
  ...
  return {
    ...
    address: pickLeadValue(data, ["address", "property_address", "project_address", "project_zip", "postal_code", "zip"], ""),
...
function buildEmailBody(data) {
  ...
  var lines = [
    ...
    "City: " + lead.city,
    "Address / ZIP: " + (lead.address || "Not entered"),
...
function buildLeadEmailHtml(data, isReview) {
  ...
  var projectRows = reviewRows + applicationRows + [
    ...
    emailInfoRow("Address / ZIP", lead.address || "Not entered", false),
...
function logToSheet(data, subject, delivery) {
  ...
  var headers = [
    ...
    "Delivery Notes", "Address / ZIP", "Budget", "Timeline", "Preferred Contact",
